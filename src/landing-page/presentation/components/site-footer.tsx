...
export function SiteFooter() {
  return (
    <footer className='border-t bg-muted/30'>
      <div className='mx-auto grid max-w-7xl gap-10 px-4 py-12 sm:px-6 md:grid-cols-[1.25fr_0.8fr_0.8fr_1fr] lg:px-8'>
        <div>
      ...
      <div className='border-t'>
        <div className='mx-auto flex max-w-7xl flex-col justify-between gap-3 px-4 py-5 text-sm text-muted-foreground sm:flex-row sm:items-center sm:px-6 lg:px-8'>
